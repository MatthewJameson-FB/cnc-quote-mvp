...
export default function Page() {
  return (
    <SeoLandingPage
      ...
      examples={[
        'A van, car or caravan part needs replacing and the original is discontinued.',
        'A small bracket or mount is missing and the vehicle can’t be finished properly.',
